		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" placeholder="课程" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" placeholder="899"/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "蓝桥云课堂  - 精品课程";
		document.getElementById("WIDtotal_amount").value = "899";
	}
	GetDateNow();
</script>
</html>